import os
import random
DATA_DIR='/home/lapuschkin/Desktop/FaceRecognition/code/AgeGenderDeepLearning/DATA/faces_squared'
original_folds_dir='/home/lapuschkin/Desktop/FaceRecognition/code/AgeGenderDeepLearning/folds/original_txt_files'
out_files_dir='/home/lapuschkin/Desktop/FaceRecognition/code/AgeGenderDeepLearning/folds/squared_unaligned_train_val_txt_files_per_fold'
...
for cur_test_fold_ind in range(5):
    ...
    for def_line in def_lines:
        ...
        image_name='coarse_tilt_aligned_face.{0}.{1}'.format(image_subject,def_line.split('\t')[1])
