...
this=gender_finetuning_caffereference_mixed/
cd $this
for i in {0..4}
do
...
this=age_finetuning_caffereference_mixed/
cd $this
for i in {0..4}
do
    #create start flag. on suceess start training. on success move model files. on success create done flag.
...
this=gender_finetuning_googlenet_mixed/
cd $this
for i in {0..4}
do
    #create start flag. on suceess start training. on success move model files. on success create done flag.
...
this=age_finetuning_googlenet_mixed/
cd $this
for i in {0..4}
do
    #create start flag. on suceess start training. on success move model files. on success create done flag.
