...
cd gender_finetuning_caffereference_unaligned
for i in {0..4}
do
...
cd age_finetuning_caffereference_unaligned
for i in {0..4}
do
    #create start flag. on suceess start training. on success move model files. on success create done flag.
...
cd gender_finetuning_googlenet_unaligned
for i in {0..4}
do
    #create start flag. on suceess start training. on success move model files. on success create done flag.
...
cd age_finetuning_googlenet_unaligned
for i in {0..4}
do
    #create start flag. on suceess start training. on success move model files. on success create done flag.
